...
const Main = () => {
    ...
    return (
        ...
        <React.Fragment>
            ...
            <h2 className="onimg">" แชร์ประสบการณ์การท่องเที่ยวด้วยตัวเองแบบไม่เหมือนใคร ไม่ต้องพึ่งทัวร์ เดินทางไม่ลำบากมาก แต่ก็ไม่หรูเกินไป เพียงแค่เป็นสมาชิกของ The traveler "</h2>
            <div className="posts">
                {posts.map(p => {
                    return(
